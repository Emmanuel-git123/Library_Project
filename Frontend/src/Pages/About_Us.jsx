        ...
        <>
            <div className='flex flex-col px-6'>
                <div className='text-6xl font-bold text-center my-6'>About Us</div>
                    <div className='grid grid-cols-2 border-4 gap-6 p-6'>
                    ...
                    <div className='flex flex-col'>
                        <div className='flex border-2 justify-evenly'>
                            <div className='flex flex-col'>
                ...
                <div className='grid grid-cols-2 py-10 px-50 gap-20'>
                    <div className='w-full min-h-lh p-5 grid-rows-2 grid gap-10'>
                        <div className='border py-5 px-8 rounded-2xl border-gray-300 hover:border-gray-400 hover:shadow-lg transition-all'>
