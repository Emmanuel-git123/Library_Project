            ...
            <div className=''>
                ...
                <div className='bg-grey-500 border border-white px-3 flex justify-between py-0.5 mb-5'>
                    ...
                    <div className='flex gap-1 items-center'>
                        {token?
                        <Link to="/" onClick={handleLogOut} className="group relative overflow-hidden text-sm w-36 bg-gray-800 h-6 text-center border-0 rounded-2xl text-white opacity-500 hover:bg-gray-900 flex items-center justify-center">
                            <span className="absolute inset-0 bg-white opacity-30 scale-0 group-hover:scale-200 transition-transform duration-1000 rounded-2xl"></span>
                            <span className="relative z-10">Logout</span>
                        </Link>
                        // :<Link to="/login" className='underline text-indigo-700 text-sm hover:text-red-500'>Login</Link>}\
                        :<Link to="/login" className='group relative overflow-hidden text-sm w-36 bg-gray-800 h-6 text-center border-0 rounded-2xl text-white opacity-500 hover:bg-gray-900'>
                            <span className='absolute inset-0 bg-white opacity-30 scale-0 group-hover:scale-200 rounded-2xl w-36'></span>
