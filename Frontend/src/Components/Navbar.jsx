        ...
        <div>
            ...
            <div>
                <div className="flex items-center justify-evenly bg-blue-950 mb-0.2">
                    ...
                    {token&&<Link to='/view/upload' className='px-3 py-3 transition-all duration-300 transform hover:scale-150 font-bold text-white text-xs hover:text-orange-400 hover:cursor-pointer flex items-center justify-center'>Upload Thesis</Link>}                
                </div>
